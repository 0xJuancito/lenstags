        ...
        <div>
            ...
            <div className="justify-between flex-wrap hidden sm:block bg-greenLengs rounded-none shadow mb-5">
                <div className="xl:w-full xl:mx-0 pl-5 pr-5 h-12">
                    <ul className="flex">
                        <li onClick={() => setActiveStatus(1)} className={activeStatus == 1 ? "text-sm text-black font-semibold flex flex-col justify-between border-indigo-700 pt-3 rounded-t mr-10 font-normal" : "text-sm text-gray-600 py-3 mr-10 font-normal cursor-pointer hover:text-gray-800"}>
                        ...
                        <li onClick={() => setActiveStatus(2)} className={activeStatus == 2 ? "text-sm text-black font-semibold flex flex-col justify-between border-indigo-700 pt-3 rounded-t mr-10 font-normal" : "text-sm text-gray-600 py-3 mr-10 font-normal cursor-pointer hover:text-gray-800"}>
                        ...
                        <li onClick={() => setActiveStatus(3)} className={activeStatus == 3 ? "text-sm text-black font-semibold flex flex-col justify-between border-indigo-700 pt-3 rounded-t mr-10 font-normal" : "text-sm text-gray-600 py-3 mr-10 font-normal cursor-pointer hover:text-gray-800"}>
